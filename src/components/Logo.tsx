...
export function LogoText(props: JSX.IntrinsicElements["svg"]) {
  return (
    <img src={logoDark} style={{width: "100%", height: "100%", padding: "0.5em"}}></img>
  );
}

export function LogoTextLight(props: JSX.IntrinsicElements["svg"]) {
  return (
    <img src={logoLight} style={{width: "100%", height: "100%", padding: "0.5em"}}></img>
  );
}
...
export function LogoIcon(props: JSX.IntrinsicElements["svg"]) {
  return (
    <img src={logoMinimalDark} style={{width: "38px", height: "38px"}}></img>
  );
}

export function LogoIconLight(props: JSX.IntrinsicElements["svg"]) {
  return (
    <img src={logoMinimalLight} style={{width: "38px", height: "38px"}}></img>
  );
}
